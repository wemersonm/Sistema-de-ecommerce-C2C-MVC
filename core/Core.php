<?php 
 ...
 <!-- 
	EX2:  www.meusite.com/login
	Controller = login == loginController
	action = index == pagina de login
	params = nada

	www.meusite.com/login/esqueci
	Controller = loginController
	action = esqueci = ação que recupera a senha

	www.meusite.com/cadastro
	Controller = cadastroController
	action = index = só mostra a pagina de cadastro

	www.meusite.com/cadastro/salvar
	Controller = cadastroController
	action = salvar o cadastro = confirmaçao
